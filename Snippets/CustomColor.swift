...
extension JPEG.RGB12: JPEG.Color {
    static func unpack(_ interleaved: [UInt16], of format: JPEG.Deep) -> [Self] {
        switch format {
        case .rgba12:
    ...
    static func pack(_ pixels: [Self], as format: JPEG.Deep) -> [UInt16] {
        switch format {
        case .rgba12:
...
guard let saved: JPEG.Data.Rectangular<JPEG.Deep> = try .decompress(path: path) else {
